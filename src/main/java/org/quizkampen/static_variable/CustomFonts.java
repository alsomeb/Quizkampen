...
public class CustomFonts {
   public static Font  Serif  = new Font       (Font.SERIF, Font.PLAIN,  CustomSizes.Button_size);
   public static Font  Dialog  = new Font      (Font.DIALOG, Font.PLAIN,  CustomSizes.Button_size);
   public static Font  Dialog_input  = new Font(Font.DIALOG, Font.PLAIN,  CustomSizes.Button_size);
   public static Font  Monospace  = new Font   (Font.MONOSPACED, Font.PLAIN,  CustomSizes.Button_size);
